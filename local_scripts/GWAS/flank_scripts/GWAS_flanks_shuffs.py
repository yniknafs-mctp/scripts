...
'''
Runs the GWAS shuffles for mulitple flank conditions
'''
...
#     gwas_file = '/mctp/projects/mitranscriptome/gwas/bed_files/gwas.sorted.bed'
    gwas_file = '/mctp/projects/mitranscriptome/gwas/bed_files/rand_snps2.sorted.bed'
#     test_script = '/mctp/users/yniknafs/scripts/workspace/local_scripts/GWAS/test.py'
    ...
    for flank, title in flanks:
        ...
        flank_file =  title + 'kb_intergenic_shuffle_randsnps.txt'
